...
class CreateListingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('listings', function (Blueprint $table) {
            ...
            $table->char('stove', 1)->nullable();
            $table->char('refrigerator', 1)->nullable();
            $table->char('dishwasher', 1)->nullable();
            $table->char('disposal', 1)->nullable();
            $table->char('washer_dryer', 1)->nullable();
            $table->char('laundry_hookup', 1)->nullable();
            $table->char('laundry_facilities', 1)->nullable();
            $table->char('air_conditioning', 1)->nullable();
            $table->char('fireplace', 1)->nullable();
            $table->char('dining_room', 1)->nullable();
            $table->char('garage', 1)->nullable();
            $table->char('fenced_yard', 1)->nullable();
            $table->char('patio', 1)->nullable();
            $table->char('swimming_pool', 1)->nullable();
            $table->char('jacuzzi', 1)->nullable();
